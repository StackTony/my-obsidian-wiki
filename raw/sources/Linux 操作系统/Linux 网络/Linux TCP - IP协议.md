...
![在这里插入图片描述]( [https://img-blog.csdnimg.cn/20210308123113714.png?x-oss-process=image/watermark](https://img-blog.csdnimg.cn/20210308123113714.png?x-oss-process=image/watermark) ,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NyYXp5bWFrZXJjaXJjbGU=,size_16,color_FFFFFF,t_70#pic_center)
...
![[9b6ad2350fab1e911a2c8531cba5693d.gif|image]]

### 交换机的诞生

虽然只比集线器多了这一点点区别，但看起来似乎有智能了，你把这东西叫做**交换机**。也正因为这一点点智能，你把它放在了另一个层级，**数据链路层**。

![[d13e6e7fb9838fe0acd6370692d57f92.png|image]]
...
![[913f402efac18571df11fb219e09f11e.png|image]]
...
![[ae47c4fd0533b29cfce00a78e784e362.gif|image]]

经过该网络中的机器不断地通信，交换机最终将 MAC 地址表建立完毕~

随着机器数量越多，交换机的端口也不够了，但聪明的你发现，只要将多个交换机连接起来，这个问题就轻而易举搞定~

![[96c4da16c077389b994e7526f2ba73f0.png|image]]
...
![[635d579c31b4ab410cd05715bc764741.png|image]]
...
![[bbcfa3e647d0bdb78a9b69cf6157c68d.png|image]]
...
![[3e0e17cfa7a0fed1b604890ef4e1cca5.png|image]]

![[84e319b3429e1000bdd3a2c2aca74fc8.png|image.gif]]

现在两个设备之间传输，除了加上数据链路层的头部之外，还要再增加一个网络层的头部。

假如 A 给 B 发送数据，由于它们直接连着交换机，所以 A 直接发出如下数据包即可，其实网络层没有体现出作用。

![[ec10004d89fc45b41721099b7408b5f0.png|image]]

但假如 A 给 C 发送数据，A 就需要先转交给路由器，然后再由路由器转交给 C。由于最底层的传输仍然需要依赖以太网，所以数据包是分成两段的。

A ~ 路由器这段的包如下：

![[36f94ba80eb664a50698787f4ba34a85.png|image]]

路由器到 C 这段的包如下：

![[adc2e43a9763d4cadae0b5abc55d636e.png|image]]
...
![[7e6a21dbdc49b7a772f1348e542cdfef.png|image]]
...
![[0c30114bad824d8d262469cea973210a.png|image]]
...
![[e48fef70877bae108f18a636b6e2d64f.gif|image]]

![[aec5c1d6632ac1c38314c03832a6bb51.png|image.gif]]
...
![[a889e11a36f66f1645d918e754a0a173.png|image]]
...
![[da2d65dda084a873779b01f59ff606aa.png|image]]

思考一分钟...

**详细过程动画描述：**

![[6740f3b2596d7bf32d214a40f58603ec.gif|image]]
...
![[7bb8957a74eef0cdc7f36df7a05702dd.png|image]]
...
![在这里插入图片描述]( [https://img-blog.csdnimg.cn/20210308122800578.png?x-oss-process=image/watermark](https://img-blog.csdnimg.cn/20210308122800578.png?x-oss-process=image/watermark) ,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NyYXp5bWFrZXJjaXJjbGU=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述]( [https://img-blog.csdnimg.cn/20210308122819964.png?x-oss-process=image/watermark](https://img-blog.csdnimg.cn/20210308122819964.png?x-oss-process=image/watermark) ,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NyYXp5bWFrZXJjaXJjbGU=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述]( [https://img-blog.csdnimg.cn/20210308122843370.png?x-oss-process=image/watermark](https://img-blog.csdnimg.cn/20210308122843370.png?x-oss-process=image/watermark) ,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NyYXp5bWFrZXJjaXJjbGU=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述]( [https://img-blog.csdnimg.cn/20210308122904344.png?x-oss-process=image/watermark](https://img-blog.csdnimg.cn/20210308122904344.png?x-oss-process=image/watermark) ,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NyYXp5bWFrZXJjaXJjbGU=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述]( [https://img-blog.csdnimg.cn/20210308123045409.png?x-oss-process=image/watermark](https://img-blog.csdnimg.cn/20210308123045409.png?x-oss-process=image/watermark) ,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NyYXp5bWFrZXJjaXJjbGU=,size_16,color_FFFFFF,t_70#pic_center)
