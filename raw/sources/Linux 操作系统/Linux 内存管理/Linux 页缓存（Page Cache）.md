...
[Linux内核内存管理——kmalloc/vmalloc系统调用|高速缓存|内存屏障|页表缓存|页回收机制|缺页中断](https://link.zhihu.com/?target=https%3A//www.bilibili.com/video/BV1UK4y1X7sq/)

[3个linux内核的秘密，让你彻底搞懂文件系统](https://link.zhihu.com/?target=https%3A//www.bilibili.com/video/BV1jg41157zg/)
...
![](https://pic2.zhimg.com/v2-1fff8af2d8099698f96977884087d251_1440w.jpg)

> Figure1. Linux 文件 I/O 系统

上图中，红色部分为 Page Cache。可见 Page Cache 的本质是由 Linux 内核管理的内存区域。我们通过 [mmap](https://zhida.zhihu.com/search?content_id=185088091&content_type=Article&match_order=1&q=mmap&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODAxMDQ4MTIsInEiOiJtbWFwIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MTg1MDg4MDkxLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.Gy8YQX87OU5IkQIukg9Ih8xYEgPa_m9eHvXos_ivKrk&zhida_source=entity) 以及 buffered I/O 将文件读取到内存空间实际上都是读取到 Page Cache 中。
...
![](https://pic3.zhimg.com/v2-8fcd958af4f30767a007130ec3c42902_1440w.jpg)
...
这是因为从磁盘中加载到内存的数据不仅仅放在 Page Cache 中，还放在 buffer cache 中。例如通过 [Direct I/O](https://zhida.zhihu.com/search?content_id=185088091&content_type=Article&match_order=1&q=Direct+I%2FO&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODAxMDQ4MTIsInEiOiJEaXJlY3QgSS9PIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MTg1MDg4MDkxLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.1IAXQjhMA6L0IxMxct69Pp9o6ee6WXVpQBOBb-Stjd4&zhida_source=entity) 技术的磁盘文件就不会进入 Page Cache 中。当然，这个问题也有 Linux 历史设计的原因，毕竟这只是一个称呼，含义随着 Linux 系统的演进也逐渐不同。

下面比较一下 File-backed pages 与 Anonymous pages 在 Swap 机制下的性能。

内存是一种珍惜资源，当内存不够用时，内存管理单元（[Memory Mangament Unit](https://zhida.zhihu.com/search?content_id=185088091&content_type=Article&match_order=1&q=Memory+Mangament+Unit&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODAxMDQ4MTIsInEiOiJNZW1vcnkgTWFuZ2FtZW50IFVuaXQiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoxODUwODgwOTEsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.B3sZjFJVDQHmEDdodSPOSN6hBe2HQsPkFj_u9TJ3xC4&zhida_source=entity)）需要提供调度算法来回收相关内存空间。内存空间回收的方式通常就是 swap，即交换到持久化存储设备上。
...
【文章福利】需要C/C++ Linux服务器架构师学习资料加群[812855908](https://link.zhihu.com/?target=https%3A//jq.qq.com/%3F_wv%3D1027%26k%3DemrFdAKk)（资料包括C/C++，Linux，golang技术，内核，Nginx，ZeroMQ，MySQL，Redis，fastdfs，MongoDB，ZK，流媒体，CDN，P2P，K8S，Docker，TCP/IP，协程，DPDK，ffmpeg，大厂面试题 等）

![](https://pic1.zhimg.com/v2-37891feadc6704ae973409a4bd006c42_1440w.jpg)

Linux 通过一个 [swappiness](https://zhida.zhihu.com/search?content_id=185088091&content_type=Article&match_order=1&q=swappiness&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODAxMDQ4MTIsInEiOiJzd2FwcGluZXNzIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MTg1MDg4MDkxLCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.iVVt1cYVgTT0rPQBnueT00Gq3cDL3OER6cwp4lBQ_7w&zhida_source=entity) 参数来控制 Swap 机制[2]：这个参数值可为 0-100，控制系统 swap 的优先级：
...
![](https://picx.zhimg.com/v2-45dd833446be8b4b94ea842c409be457_1440w.jpg)
...
![](https://pic4.zhimg.com/v2-07387a93aafd63fd84d5c5c8307067b3_1440w.jpg)

Page Cache 中的每个文件都是一棵基数树（radix tree，本质上是多叉搜索树），树的每个节点都是一个页。根据文件内的偏移量就可以快速定位到所在的页，如下图所示。关于基数树的原理可以参见英文维基，这里就不细说了。

![](https://pica.zhimg.com/v2-1f66bb107ad132267476b3d3167ad7f4_1440w.jpg)
...
![](https://pic2.zhimg.com/v2-170fb78bc43c47249468b78eebc83875_1440w.jpg)
...
![](https://pic1.zhimg.com/v2-b93833fcea11f844c7657c78f49b9dea_1440w.jpg)
