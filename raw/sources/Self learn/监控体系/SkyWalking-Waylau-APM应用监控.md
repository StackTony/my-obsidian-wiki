---
title: 使用 SkyWalking 实现应用性能监控
created: 2026-05-18
tags: [SkyWalking, APM, 微服务监控, 分布式追踪]
credibility: low
source_url: https://waylau.com/application-performance-monitor-and-skywalking/
---
...
SkyWalking平台管理界面地址为： [http://192.168.1.86:19000/](http://192.168.1.86:19000/)

应用接入SkyWalking平台的方式分为Java项目接入和Node.js项目接入。接入完成之后，可以在上述管理界面进行查看应用信息。

### Java项目接入

下载 Apache SkyWalking的Java Agent： [https://dlcdn.apache.org/skywalking/java-agent/9.3.0/apache-skywalking-java-agent-9.3.0.tgz](https://dlcdn.apache.org/skywalking/java-agent/9.3.0/apache-skywalking-java-agent-9.3.0.tgz)
...
- skywalking.agent.service\_name 配置你应用的名称。不同环境可用加环境后缀进行区分。例如：planner-workbench-server-dev、planner-workbench-server-sit
- skywalking.collector.backend\_service 配置SkyWalking平台地址。其中11800为默认接入端口

上述配置，也可用通过容器的环境变量来修改

参考： [https://skywalking.apache.org/docs/skywalking-java/latest/en/setup/service-agent/java-agent/readme/#setup-java-agent](https://skywalking.apache.org/docs/skywalking-java/latest/en/setup/service-agent/java-agent/readme/#setup-java-agent)
...
参考： [https://www.npmjs.com/package/skywalking-backend-js](https://www.npmjs.com/package/skywalking-backend-js)