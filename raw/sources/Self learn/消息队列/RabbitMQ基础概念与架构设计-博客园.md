...
- `RoutingKey` (路由键)：消息头的一个属性，用于标记消息的路由规则，决定了交换机的转发路径。最大长度255 字节。如下图，当我们创建好交换机和队列后，需要使用路由键将两者进行绑定，所以路由键也叫绑定键(`BindingKey` ）。当消息生产者向交换机发送消息时，必须指定一个路由键，当交换机收到这条消息之后，会解析并获取路由键，然后同交换机和队列的绑定规则，并将消息分发到符合规则的队列中。
	...
	![](https://img2024.cnblogs.com/blog/1569452/202409/1569452-20240901233953556-2114100603.png)
...
注意，如果没有为队列设置特定的路由键，则队列上的消息将使用 *所有* 原始路由键进行死信处理。这包括由·CC `和` BCC\`头添加的路由键。
...
全国软件测试QQ交流群： [7156436](https://shang.qq.com/wpa/qunwpa?idkey=b92033e9c78cb53f6fffb88f92a2dba1ed61a1ef344f4d20b286ebc3cef5bcc2)  
Git地址： [https://gitee.com/ishouke](https://gitee.com/ishouke)  
![](https://www.cnblogs.com/images/cnblogs_com/shouke/1368383/t_%E5%BE%AE%E4%BF%A1%E6%94%B6%E6%AC%BE%E7%A0%81.bmp)