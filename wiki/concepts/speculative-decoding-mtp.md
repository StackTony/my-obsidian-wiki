...
[[concepts/llm-quantization-engineering|FP8/AWQ量化]]后decode带宽瓶颈减轻，推测收益下降。但draft可以更激进量化（INT4），总体1.5-2x收益保留。 ^[inferred]
...
| 引擎 | 推测支持 |
|------|---------|
| [[entities/vllm-sglang-tensorrt|推理引擎对比]] (vLLM >=0.6) | Medusa/EAGLE/self-speculative |
| [[entities/vllm-sglang-tensorrt|推理引擎对比]] (SGLang) | EAGLE |
